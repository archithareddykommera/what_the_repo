...
class EngineerLensDataProcessor:
    ...
    def _init_supabase(self):
        ...
        try:
            supabase_url = os.getenv('SUPABASE_URL', 'https://gswsocmxsdltppixpfvp.supabase.co')
            supabase_key = os.getenv('SUPABASE_SERVICE_ROLE_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdzd3NvY214c2RsdHBwaXhwZnZwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NTAyNzM1OCwiZXhwIjoyMDcwNjAzMzU4fQ.QcD0V6dzrAE3wtaWbG8G-EY67wLo6Oqvharve8QS06M')
